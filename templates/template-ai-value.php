<?php
/**
 * AI Value Bets Analysis template - Enhanced UI
 */
            ...
            <?php foreach ($analysis as $item): ?>
                <div class="bsp-v2-analysis-item">
                    ...
                    <div class="bsp-v2-analysis-meta">
                        <span><strong>EV:</strong> <?php echo esc_html(number_format($item['ev'] ?? 0, 1)); ?>%</span>
                        <span><strong>Odds:</strong> <?php echo esc_html(number_format($item['odds'] ?? 1, 2)); ?></span>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
